...
## Release_1.8.1_20250828_build_A
...
## Release_1.8.0_20250827_build_A
...
## Release_1.7.0_20250823_build_A
...
- SPI 目录结构优化。
  ...
  - 将判断机制的 SPI 接口与抽象类提相关代码文件提升至 `sdk` 模块中。
  - 将下沉机制的 SPI 接口与抽象类提相关代码文件提升至 `sdk` 模块中。
