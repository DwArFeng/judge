...
## Release_2.6.1_20260604_build_A
...
- 实现预设判断器。
  - com.dwarfeng.judge.impl.handler.judger.threshold.ThresholdJudgerRegistry。
...
## Release_2.6.0_20260604_build_A
...
## Release_2.5.2_20260521_build_A
...
## Release_2.5.1_20260521_build_A
...
## Release_2.5.0_20260513_build_A
...
- `settingrepo-stack` 子模块类优化注释、文档注释格式、代码换行格式。
  ...
  - com.dwarfeng.judge.stack.service.ProviderInfoMaintainService。
...
- 依赖升级。
  ...
  - 升级 `dwarfeng-ftp` 依赖版本为 `1.5.0.a` 以规避漏洞。
...
## Release_2.4.3_20260409_build_A
...
## Release_2.4.2_20251229_build_A
