...
@Table(name = "tbl_provider_support")
public class HibernateProviderSupport implements Bean {

    private static final long serialVersionUID = -6071475971492382826L;
    ...
    public HibernateProviderSupport() {
    }
