...
public class EvaluateConsumerCommand extends CliCommand {
    ...
    private static final String CMD_LINE_SYNTAX_L = "ecsu -l";
    private static final String CMD_LINE_SYNTAX_S = "ecsu -s [-b val] [-t val]";
    ...
    public EvaluateConsumerCommand(EvaluateQosService evaluateQosService) {
    ...
    private void handleS(Context context, CommandLine cmd) throws Exception {
        ...
        ConsumerStatus consumerStatus = evaluateQosService.getConsumerStatus();
        ...
        evaluateQosService.setConsumerParameters(bufferSize, thread);
