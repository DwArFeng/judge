...
import com.dwarfeng.judge.sdk.bean.entity.FastJsonAnalysisFilePack;
...
@Repository
public class AnalysisFilePackCacheImpl implements AnalysisFilePackCache {

    private final RedisBatchBaseCache<LongIdKey, AnalysisFilePack, FastJsonAnalysisFilePack> batchBaseCache;

    public AnalysisFilePackCacheImpl(
            RedisBatchBaseCache<LongIdKey, AnalysisFilePack, FastJsonAnalysisFilePack> batchBaseCache
    ) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public AnalysisFilePack get(LongIdKey key) throws CacheException {
    ...
    public void push(AnalysisFilePack value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<AnalysisFilePack> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<AnalysisFilePack> entities, long timeout) throws CacheException {
