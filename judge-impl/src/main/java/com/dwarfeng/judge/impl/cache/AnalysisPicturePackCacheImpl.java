...
import com.dwarfeng.judge.sdk.bean.entity.FastJsonAnalysisPicturePack;
...
@Repository
public class AnalysisPicturePackCacheImpl implements AnalysisPicturePackCache {

    private final RedisBatchBaseCache<LongIdKey, AnalysisPicturePack, FastJsonAnalysisPicturePack> batchBaseCache;

    public AnalysisPicturePackCacheImpl(
            RedisBatchBaseCache<LongIdKey, AnalysisPicturePack, FastJsonAnalysisPicturePack> batchBaseCache
    ) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public AnalysisPicturePack get(LongIdKey key) throws CacheException {
    ...
    public void push(AnalysisPicturePack value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<AnalysisPicturePack> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<AnalysisPicturePack> entities, long timeout) throws CacheException {
