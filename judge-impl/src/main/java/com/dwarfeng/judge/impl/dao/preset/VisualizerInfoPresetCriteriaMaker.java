...
public class VisualizerInfoPresetCriteriaMaker implements PresetCriteriaMaker {
    ...
    public void makeCriteria(DetachedCriteria criteria, String preset, Object[] objs) {
        switch (preset) {
            case VisualizerInfoMaintainService.CHILD_FOR_SECTION:
                childForSection(criteria, objs);
                break;
            case VisualizerInfoMaintainService.CHILD_FOR_SECTION_INDEX_ASC:
                childForSectionIndexAsc(criteria, objs);
                break;
            case VisualizerInfoMaintainService.CHILD_FOR_SECTION_ENABLED:
                childForSectionEnabled(criteria, objs);
                break;
            case VisualizerInfoMaintainService.CHILD_FOR_SECTION_ENABLED_INDEX_ASC:
