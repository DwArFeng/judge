...
import com.dwarfeng.judge.sdk.bean.entity.FastJsonSinkerInfo;
...
@Repository
public class SinkerInfoCacheImpl implements SinkerInfoCache {

    private final RedisBatchBaseCache<LongIdKey, SinkerInfo, FastJsonSinkerInfo> batchBaseCache;

    public SinkerInfoCacheImpl(RedisBatchBaseCache<LongIdKey, SinkerInfo, FastJsonSinkerInfo> batchBaseCache) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public SinkerInfo get(LongIdKey key) throws CacheException {
    ...
    public void push(SinkerInfo value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<SinkerInfo> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<SinkerInfo> entities, long timeout) throws CacheException {
