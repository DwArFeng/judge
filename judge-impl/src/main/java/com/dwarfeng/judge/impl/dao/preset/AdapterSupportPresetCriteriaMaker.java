...
@Component
public class AdapterSupportPresetCriteriaMaker implements PresetCriteriaMaker {

    @Override
    public void makeCriteria(DetachedCriteria criteria, String preset, Object[] objs) {
        switch (preset) {
            case AdapterSupportMaintainService.ID_LIKE:
                idLike(criteria, objs);
                break;
            case AdapterSupportMaintainService.LABEL_LIKE:
