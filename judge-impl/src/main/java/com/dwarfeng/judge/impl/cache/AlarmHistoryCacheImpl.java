...
import com.dwarfeng.judge.sdk.bean.entity.FastJsonAlarmHistory;
import com.dwarfeng.judge.stack.bean.entity.AlarmHistory;
import com.dwarfeng.judge.stack.cache.AlarmHistoryCache;
...
@Repository
public class AlarmHistoryCacheImpl implements AlarmHistoryCache {

    private final RedisBatchBaseCache<LongIdKey, AlarmHistory, FastJsonAlarmHistory> batchBaseCache;

    public AlarmHistoryCacheImpl(RedisBatchBaseCache<LongIdKey, AlarmHistory, FastJsonAlarmHistory> batchBaseCache) {
