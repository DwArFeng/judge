...
import com.dwarfeng.judge.sdk.bean.entity.FastJsonAnalysisPictureInfo;
...
@Repository
public class AnalysisPictureInfoCacheImpl implements AnalysisPictureInfoCache {

    private final RedisBatchBaseCache<LongIdKey, AnalysisPictureInfo, FastJsonAnalysisPictureInfo> batchBaseCache;

    public AnalysisPictureInfoCacheImpl(
            RedisBatchBaseCache<LongIdKey, AnalysisPictureInfo, FastJsonAnalysisPictureInfo> batchBaseCache
    ) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public AnalysisPictureInfo get(LongIdKey key) throws CacheException {
    ...
    public void push(AnalysisPictureInfo value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<AnalysisPictureInfo> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<AnalysisPictureInfo> entities, long timeout) throws CacheException {
