...
@Table(name = "tbl_driver_support")
public class HibernateDriverSupport implements Bean {

    private static final long serialVersionUID = -4778313659695681641L;
