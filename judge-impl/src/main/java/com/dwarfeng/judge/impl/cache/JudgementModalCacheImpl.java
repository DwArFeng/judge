...
@Repository
public class JudgementModalCacheImpl implements JudgementModalCache {

    private final RedisBatchBaseCache<LongIdKey, JudgementModal, FastJsonJudgementModal> batchBaseCache;

    public JudgementModalCacheImpl(
            RedisBatchBaseCache<LongIdKey, JudgementModal, FastJsonJudgementModal> batchBaseCache
    ) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public JudgementModal get(LongIdKey key) throws CacheException {
    ...
    public void push(JudgementModal value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<JudgementModal> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<JudgementModal> entities, long timeout) throws CacheException {
