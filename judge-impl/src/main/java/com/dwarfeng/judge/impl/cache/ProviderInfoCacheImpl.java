...
import com.dwarfeng.judge.sdk.bean.entity.FastJsonProviderInfo;
import com.dwarfeng.judge.stack.bean.entity.ProviderInfo;
import com.dwarfeng.judge.stack.cache.ProviderInfoCache;
...
@Repository
public class ProviderInfoCacheImpl implements ProviderInfoCache {

    private final RedisBatchBaseCache<LongIdKey, ProviderInfo, FastJsonProviderInfo> batchBaseCache;

    public ProviderInfoCacheImpl(RedisBatchBaseCache<LongIdKey, ProviderInfo, FastJsonProviderInfo> batchBaseCache) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public ProviderInfo get(LongIdKey key) throws CacheException {
    ...
    public void push(ProviderInfo value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<ProviderInfo> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<ProviderInfo> entities, long timeout) throws CacheException {
