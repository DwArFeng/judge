...
import com.dwarfeng.judge.sdk.bean.entity.FastJsonSinkerSupport;
import com.dwarfeng.judge.stack.bean.entity.SinkerSupport;
import com.dwarfeng.judge.stack.cache.SinkerSupportCache;
...
@Repository
public class SinkerSupportCacheImpl implements SinkerSupportCache {

    private final RedisBatchBaseCache<StringIdKey, SinkerSupport, FastJsonSinkerSupport> batchBaseCache;

    public SinkerSupportCacheImpl(RedisBatchBaseCache<StringIdKey, SinkerSupport, FastJsonSinkerSupport> batchBaseCache) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public SinkerSupport get(StringIdKey key) throws CacheException {
    ...
    public void push(SinkerSupport value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<SinkerSupport> batchGet(@SkipRecord List<StringIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<SinkerSupport> entities, long timeout) throws CacheException {
