...
@Table(name = "tbl_adapter_support")
public class HibernateAdapterSupport implements Bean {

    private static final long serialVersionUID = -3268796050304722075L;
    ...
    public HibernateAdapterSupport() {
    }
