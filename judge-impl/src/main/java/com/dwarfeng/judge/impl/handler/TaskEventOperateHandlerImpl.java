...
import com.dwarfeng.judge.stack.handler.TaskEventOperateHandler;
...
public class TaskEventOperateHandlerImpl implements TaskEventOperateHandler {
    ...
    static {
        ...
        VALID_TASK_STATUS_SET_CREATE = Collections.unmodifiableSet(
                VALID_TASK_STATUS_SET_CREATE_DEJA_VU
        );
    }
    ...
    private TaskEventCreateResult create0(TaskEventCreateInfo info) throws Exception {
        // 展开参数。
