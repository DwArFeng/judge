...
public class EnabledJudgerInfoCacheImpl implements EnabledJudgerInfoCache {
    ...
    public void set(LongIdKey key, @SkipRecord Collection<JudgerInfo> entities, long timeout) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void leftPush(LongIdKey key, @SkipRecord Collection<JudgerInfo> entities, long timeout) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void rightPush(LongIdKey key, @SkipRecord Collection<JudgerInfo> entities, long timeout) throws CacheException {
