 ...
 */
@Component
public class RoutedRepository extends AbstractRepository {

    public static final String REPOSITORY_TYPE = "routed";
    ...
    public void init() {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            if (Objects.equals(REPOSITORY_TYPE, repositoryType)) {
    ...
    public void putData(String category, Object[] args) throws RepositoryException {
        try {
            ...
            repositoryMap.get(split[0]).putData(split[1], args);
        } catch (RepositoryException e) {
            throw e;
        } catch (Exception e) {
            throw new RepositoryException(e);
