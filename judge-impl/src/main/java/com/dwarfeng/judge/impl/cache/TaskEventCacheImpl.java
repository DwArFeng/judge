...
import com.dwarfeng.judge.sdk.bean.entity.FastJsonTaskEvent;
...
public class TaskEventCacheImpl implements TaskEventCache {
    ...
    public TaskEventCacheImpl(
            RedisBatchBaseCache<LongIdKey, TaskEvent, FastJsonTaskEvent> batchBaseCache
    ) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public TaskEvent get(LongIdKey key) throws CacheException {
    ...
    public void push(TaskEvent value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<TaskEvent> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<TaskEvent> entities, long timeout) throws CacheException {
