...
import com.dwarfeng.judge.sdk.bean.entity.FastJsonAnalysisFileInfo;
...
@Repository
public class AnalysisFileInfoCacheImpl implements AnalysisFileInfoCache {

    private final RedisBatchBaseCache<LongIdKey, AnalysisFileInfo, FastJsonAnalysisFileInfo> batchBaseCache;

    public AnalysisFileInfoCacheImpl(
            RedisBatchBaseCache<LongIdKey, AnalysisFileInfo, FastJsonAnalysisFileInfo> batchBaseCache
    ) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public AnalysisFileInfo get(LongIdKey key) throws CacheException {
    ...
    public void push(AnalysisFileInfo value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<AnalysisFileInfo> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<AnalysisFileInfo> entities, long timeout) throws CacheException {
