...
import com.dwarfeng.judge.sdk.bean.entity.FastJsonAdapterInfo;
import com.dwarfeng.judge.stack.bean.entity.AdapterInfo;
import com.dwarfeng.judge.stack.cache.AdapterInfoCache;
...
@Repository
public class AdapterInfoCacheImpl implements AdapterInfoCache {

    private final RedisBatchBaseCache<LongIdKey, AdapterInfo, FastJsonAdapterInfo> batchBaseCache;

    public AdapterInfoCacheImpl(RedisBatchBaseCache<LongIdKey, AdapterInfo, FastJsonAdapterInfo> batchBaseCache) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public AdapterInfo get(LongIdKey key) throws CacheException {
    ...
    public void push(AdapterInfo value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<AdapterInfo> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<AdapterInfo> entities, long timeout) throws CacheException {
