...
@Component
public class AnalysisPicturePackItemInfoPresetCriteriaMaker implements PresetCriteriaMaker {

    @Override
    public void makeCriteria(DetachedCriteria criteria, String preset, Object[] objs) {
        switch (preset) {
            case AnalysisPicturePackItemInfoMaintainService.CHILD_FOR_PACK:
                childForPack(criteria, objs);
                break;
            case AnalysisPicturePackItemInfoMaintainService.CHILD_FOR_PACK_INDEX_ASC:
