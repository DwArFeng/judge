...
@Table(name = "tbl_analyser_support")
public class HibernateAnalyserSupport implements Bean {

    private static final long serialVersionUID = -689236585780467842L;
    ...
    public HibernateAnalyserSupport() {
    }
