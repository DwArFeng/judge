...
import com.dwarfeng.judge.stack.cache.AlarmModalCache;
...
@Repository
public class AlarmModalCacheImpl implements AlarmModalCache {

    private final RedisBatchBaseCache<LongIdKey, AlarmModal, FastJsonAlarmModal> batchBaseCache;

    public AlarmModalCacheImpl(RedisBatchBaseCache<LongIdKey, AlarmModal, FastJsonAlarmModal> batchBaseCache) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public AlarmModal get(LongIdKey key) throws CacheException {
    ...
    public void push(AlarmModal value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<AlarmModal> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<AlarmModal> entities, long timeout) throws CacheException {
