...
@Component
public class VisualizerSupportPresetCriteriaMaker implements PresetCriteriaMaker {

    @Override
    public void makeCriteria(DetachedCriteria criteria, String preset, Object[] objs) {
        switch (preset) {
            case VisualizerSupportMaintainService.ID_LIKE:
                idLike(criteria, objs);
                break;
            case VisualizerSupportMaintainService.LABEL_LIKE:
