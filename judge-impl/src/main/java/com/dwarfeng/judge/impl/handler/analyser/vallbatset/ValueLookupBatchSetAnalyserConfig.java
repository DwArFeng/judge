 ...
 *
 * <p>
 * 该配置描述一次 lookup 查询参数以及多个输出 <code>Analysis</code> 的写入规则。
 * 分析器执行单次 <code>Context.lookup(...)</code>，再按 <code>outputs</code> 批量取值、转换类型并写入目标分析结果。
 *
 * @author DwArFeng
 * @since 2.6.1
 */
public class ValueLookupBatchSetAnalyserConfig implements Bean {

    private static final long serialVersionUID = -6733568450108971384L;
    ...
    private String outputsRem = "输出 Analysis 写入规则数组，必填且不能为空。";

    @JSONField(name = "outputs", ordinal = 4)
    private List<OutputConfig> outputs;

    public ValueLookupBatchSetAnalyserConfig() {
    }

    public ValueLookupBatchSetAnalyserConfig(LookupConfig lookup, List<OutputConfig> outputs) {
        this.lookup = lookup;
    ...
    public String toString() {
        return "ValueLookupBatchSetAnalyserConfig{" +
                "lookupRem='" + lookupRem + '\'' +
                ", lookup=" + lookup +
    ...
    public static class LookupConfig implements Bean {
        ...
        private static final long serialVersionUID = 884694315477996878L;
    ...
    public static class LookupObjectConfig implements Bean {
        ...
        private static final long serialVersionUID = -4349590286185603044L;
     ...
     *
     * <p>
     * 该配置描述一个目标 <code>Analysis</code> 的输出键、值类型以及从 lookup 结果中取值的规则。
     *
     * @author DwArFeng
     * @since 2.6.1
     */
    public static class OutputConfig implements Bean {
        ...
        private static final long serialVersionUID = -2467482654143783780L;
        ...
        @JSONField(name = "#lookup_result", ordinal = 5)
        private String lookupResultRem = "从本次 lookup 结果中取值的规则，必填。";

        @JSONField(name = "lookup_result", ordinal = 6)
        ...
        public OutputConfig(
                String outputAnalysisDataId, String outputAnalysisValueType, LookupResultConfig lookupResult
        ) {
    ...
    public static class LookupResultConfig implements Bean {
        ...
        private static final long serialVersionUID = -8058037077504186256L;
