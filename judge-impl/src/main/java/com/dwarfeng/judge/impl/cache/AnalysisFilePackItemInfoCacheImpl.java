...
import com.dwarfeng.judge.sdk.bean.entity.FastJsonAnalysisFilePackItemInfo;
...
@Repository
public class AnalysisFilePackItemInfoCacheImpl implements AnalysisFilePackItemInfoCache {

    private final RedisBatchBaseCache<LongIdKey, AnalysisFilePackItemInfo, FastJsonAnalysisFilePackItemInfo>
            batchBaseCache;

    public AnalysisFilePackItemInfoCacheImpl(
            RedisBatchBaseCache<LongIdKey, AnalysisFilePackItemInfo, FastJsonAnalysisFilePackItemInfo> batchBaseCache
    ) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public AnalysisFilePackItemInfo get(LongIdKey key) throws CacheException {
    ...
    public void push(AnalysisFilePackItemInfo value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<AnalysisFilePackItemInfo> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<AnalysisFilePackItemInfo> entities, long timeout) throws CacheException {
