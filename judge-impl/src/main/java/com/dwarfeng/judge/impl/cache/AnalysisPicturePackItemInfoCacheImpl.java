...
import com.dwarfeng.judge.sdk.bean.entity.FastJsonAnalysisPicturePackItemInfo;
...
@Repository
public class AnalysisPicturePackItemInfoCacheImpl implements AnalysisPicturePackItemInfoCache {

    private final RedisBatchBaseCache<LongIdKey, AnalysisPicturePackItemInfo, FastJsonAnalysisPicturePackItemInfo>
            batchBaseCache;

    public AnalysisPicturePackItemInfoCacheImpl(
            RedisBatchBaseCache<LongIdKey, AnalysisPicturePackItemInfo, FastJsonAnalysisPicturePackItemInfo>
                    batchBaseCache
    ) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public AnalysisPicturePackItemInfo get(LongIdKey key) throws CacheException {
    ...
    public void push(AnalysisPicturePackItemInfo value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<AnalysisPicturePackItemInfo> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<AnalysisPicturePackItemInfo> entities, long timeout) throws CacheException {
