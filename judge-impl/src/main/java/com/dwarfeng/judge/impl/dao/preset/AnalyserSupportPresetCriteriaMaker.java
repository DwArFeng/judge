...
@Component
public class AnalyserSupportPresetCriteriaMaker implements PresetCriteriaMaker {

    @Override
    public void makeCriteria(DetachedCriteria criteria, String preset, Object[] objs) {
        switch (preset) {
            case AnalyserSupportMaintainService.ID_LIKE:
                idLike(criteria, objs);
                break;
            case AnalyserSupportMaintainService.LABEL_LIKE:
