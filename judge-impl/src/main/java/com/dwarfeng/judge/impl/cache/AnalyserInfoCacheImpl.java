...
import com.dwarfeng.judge.sdk.bean.entity.FastJsonAnalyserInfo;
...
@Repository
public class AnalyserInfoCacheImpl implements AnalyserInfoCache {

    private final RedisBatchBaseCache<LongIdKey, AnalyserInfo, FastJsonAnalyserInfo> batchBaseCache;

    public AnalyserInfoCacheImpl(RedisBatchBaseCache<LongIdKey, AnalyserInfo, FastJsonAnalyserInfo> batchBaseCache) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public AnalyserInfo get(LongIdKey key) throws CacheException {
    ...
    public void push(AnalyserInfo value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<AnalyserInfo> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<AnalyserInfo> entities, long timeout) throws CacheException {
