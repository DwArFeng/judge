...
public class SupportCommand extends CliCommand {
    ...
    protected List<Option> buildOptions() {
        ...
        list.add(Option.builder().longOpt(COMMAND_OPTION_RESET_DRIVER).desc("重置驱动器").build());
        list.add(Option.builder().longOpt(COMMAND_OPTION_RESET_JUDGER).desc("重置判断器").build());
        return list;
    }
