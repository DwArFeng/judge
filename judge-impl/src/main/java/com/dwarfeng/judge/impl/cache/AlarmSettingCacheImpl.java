...
import com.dwarfeng.judge.sdk.bean.entity.FastJsonAlarmSetting;
import com.dwarfeng.judge.stack.bean.entity.AlarmSetting;
import com.dwarfeng.judge.stack.cache.AlarmSettingCache;
...
public class AlarmSettingCacheImpl implements AlarmSettingCache {
    ...
    private final RedisBatchBaseCache<LongIdKey, AlarmSetting, FastJsonAlarmSetting> batchBaseCache;

    public AlarmSettingCacheImpl(RedisBatchBaseCache<LongIdKey, AlarmSetting, FastJsonAlarmSetting> batchBaseCache) {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<AlarmSetting> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<AlarmSetting> entities, long timeout) throws CacheException {
