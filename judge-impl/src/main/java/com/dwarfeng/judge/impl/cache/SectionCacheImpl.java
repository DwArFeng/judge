...
public class SectionCacheImpl implements SectionCache {
    ...
    @Autowired
    private RedisBatchBaseCache<LongIdKey, Section, FastJsonSection> batchBaseCache;
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<Section> batchGet(List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(List<Section> entities, long timeout) throws CacheException {
