...
public class SectionCacheImpl implements SectionCache {
    ...
    private final RedisBatchBaseCache<LongIdKey, Section, FastJsonSection> batchBaseCache;

    public SectionCacheImpl(RedisBatchBaseCache<LongIdKey, Section, FastJsonSection> batchBaseCache) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public Section get(LongIdKey key) throws CacheException {
    ...
    public void push(Section value, long timeout) throws CacheException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<Section> batchGet(@SkipRecord List<LongIdKey> keys) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<Section> entities, long timeout) throws CacheException {
