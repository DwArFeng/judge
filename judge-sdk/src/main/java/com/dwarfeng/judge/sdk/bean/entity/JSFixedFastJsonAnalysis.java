...
import com.dwarfeng.judge.sdk.bean.key.JSFixedFastJsonAnalysisKey;
...
public class JSFixedFastJsonAnalysis implements Bean {
    ...
    private static final long serialVersionUID = 8849188934593436939L;
    ...
    public static JSFixedFastJsonAnalysis of(Analysis analysis) {
        if (Objects.isNull(analysis)) {
            ...
            return new JSFixedFastJsonAnalysis(
                    JSFixedFastJsonAnalysisKey.of(analysis.getKey()),
    ...
    private JSFixedFastJsonAnalysisKey key;
    ...
    @JSONField(name = "picture_value", ordinal = 8, serializeUsing = ToStringSerializer.class)
    private Long pictureValue;

    @JSONField(name = "picture_pack_value", ordinal = 9, serializeUsing = ToStringSerializer.class)
    private Long picturePackValue;

    @JSONField(name = "file_value", ordinal = 10, serializeUsing = ToStringSerializer.class)
    private Long fileValue;

    @JSONField(name = "file_pack_value", ordinal = 11, serializeUsing = ToStringSerializer.class)
    ...
    public JSFixedFastJsonAnalysis(
            JSFixedFastJsonAnalysisKey key, int dataType, String stringValue, Long longValue, Double doubleValue,
    ...
    public JSFixedFastJsonAnalysisKey getKey() {
        return key;
    }

    public void setKey(JSFixedFastJsonAnalysisKey key) {
        this.key = key;
    }
