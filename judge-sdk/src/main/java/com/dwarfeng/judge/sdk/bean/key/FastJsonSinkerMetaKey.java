 ...
 * @since 2.1.0-beta
 */
public class FastJsonSinkerMetaKey implements Key {

    private static final long serialVersionUID = -7044757545485822438L;

    public static FastJsonSinkerMetaKey of(SinkerMetaKey sinkerMetaKey) {
        if (Objects.isNull(sinkerMetaKey)) {
            return null;
        } else {
            return new FastJsonSinkerMetaKey(
    ...
    public FastJsonSinkerMetaKey() {
    }

    public FastJsonSinkerMetaKey(Long sectionLongId, Long sinkerLongId, String metaStringId) {
    ...
    public boolean equals(Object o) {
        ...
        FastJsonSinkerMetaKey that = (FastJsonSinkerMetaKey) o;
