...
/**
 * FastJson 分析结果文件包条目信息。
 *
 * @author DwArFeng
 * @since 2.0.0
 */
public class FastJsonAnalysisFilePackItemInfo implements Bean {

    private static final long serialVersionUID = -7722217941808159991L;

    public static FastJsonAnalysisFilePackItemInfo of(AnalysisFilePackItemInfo analysisFilePackItemInfo) {
        if (Objects.isNull(analysisFilePackItemInfo)) {
            return null;
        } else {
            return new FastJsonAnalysisFilePackItemInfo(
                    FastJsonLongIdKey.of(analysisFilePackItemInfo.getKey()),
                    FastJsonLongIdKey.of(analysisFilePackItemInfo.getPackKey()),
    ...
    public FastJsonAnalysisFilePackItemInfo() {
    }
    ...
    public String toString() {
        return "FastJsonAnalysisFilePackItemInfo{" +
                "key=" + key +
                ", packKey=" + packKey +
                ", index=" + index +
