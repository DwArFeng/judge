...
public interface Filter {
     ...
     * @since 2.6.0
     */
    FilterResult filter(FilterInfo info) throws FilterException;
    ...
    final class FilterInfo {
        ...
        public FilterInfo(List<Map<String, Object>> datas, Map<String, Object> meta) {
            this.datas = datas;
            this.meta = meta;
        }
    ...
    final class FilterResult {
        ...
        public FilterResult(List<Map<String, Object>> datas, Map<String, Object> meta) {
            this.datas = datas;
            this.meta = meta;
        }
