 ...
 * @since 2.1.0-beta
 */
public class SinkerMetaCompleteInfo implements Dto {

    private static final long serialVersionUID = 3484106598776510713L;

    private LongIdKey sectionKey;
    private LongIdKey sinkerInfoKey;

    public SinkerMetaCompleteInfo() {
    }

    public SinkerMetaCompleteInfo(LongIdKey sectionKey, LongIdKey sinkerInfoKey) {
