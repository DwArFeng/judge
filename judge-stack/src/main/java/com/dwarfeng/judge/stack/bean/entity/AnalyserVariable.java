...
public class AnalyserVariable implements Entity<AnalyserVariableKey> {
    ...
    private static final long serialVersionUID = -7738517022618368329L;
    ...
    public AnalyserVariable(
            AnalyserVariableKey key, int valueType, String stringValue, Long longValue, Double doubleValue,
